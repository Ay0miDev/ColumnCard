...
const cardList = cardDetails.map((card) => (
    ...
    >
        ...
        <button className='dark:bg-black dark:text-white bg-slate-50 hover:bg-transparent border-solid dark:border-2 border-2 border-spacing-7 dark:border-black border-white dark:hover:bg-transparent hover:text-white cursor-pointer text-black py-2 px-5 text-xs rounded-2xl'>Learn More</button>
    </div>
));
  return (
